...
<head>
    ...
    <title>GLOBAL AXE | Ajout d'une photo</title>
...
<body class="flex flex-col items-center justify-center text-xl">
    ...
    <div class="w-11/12 py-10 space-y-5 flex flex-col items-center">
        <h1 class="text-5xl">Ajout d'une photo</h1>
    ...
    <div class="w-11/12 flex justify-center">
        <form action="admin/traitement/addphotos.php" method="post" enctype="multipart/form-data"
            ...
            <div class="w-full">
                <div class="w-full lg:space-y-3 space-y-2">
                    <div class="flex flex-col items-start w-full">
                        ...
                        <input type="text" for="addphoto" id="nom" name="nom" class="rounded w-full p-1 text-black">
                    </div>
                    <div class="flex flex-col items-start w-full">
                        <label for="image">Image*</label>
                        <input type="file" for="addphoto" id="image" name="image" class="rounded w-full p-1 text-black">
                    </div>
                    <div class="flex flex-col items-start w-full">
