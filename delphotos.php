...
require 'admin/traitement/delphotos.php';
?>
...
<head>
    ...
    <title>GLOBAL AXE | Suppression d'une photo</title>
...
<body class="flex flex-col items-center justify-center text-xl">
    ...
    <div class="w-11/12 py-10 space-y-5 flex flex-col items-center">
        <h1 class="text-5xl">Suppression d'une photo</h1>
    ...
    <div class="w-11/12 flex justify-center">
        <form class="flex flex-col items-center" action="delphotos.php" method="post">
