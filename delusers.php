...
require 'admin/traitement/delusers.php';
?>
...
<head>
    ...
    <title>GLOBAL AXE | Suppression d'un utilisateur</title>
...
<body class="flex flex-col items-center justify-center text-xl">
    ...
    <div class="w-11/12 py-10 space-y-5 flex flex-col items-center">
        <h1 class="text-5xl">Suppression d'un utilisateur</h1>
    ...
    <div class="w-11/12 flex justify-center">
        <form class="flex flex-col items-center" action="delusers.php" method="post">
